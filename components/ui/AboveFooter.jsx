...
async function AboveFooter() {
    ...
    return (
        <div className="border-y-[.3px] border-slate-200 dark:bg-transparent mt-[50px]">
            <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 lg:divide-x dark:divide-slate-800 divide-slate-200 rtl:divide-x-reverse">
                {/* Item 1 */}
                ...
                {/* Item 2 */}
                <div className="flex flex-col items-center justify-center text-center py-10 px-4 ltr:border-l-[.3px] rtl:border-r-[.3px] border-slate-200">
                ...
                {/* Item 3 */}
                <div className="flex flex-col items-center justify-center text-center py-10 px-4 ltr:border-r-[.3px] rtl:border-l-[.3px] border-slate-200">
